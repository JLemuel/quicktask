        ...
        <GuestLayout>
            ...
            <form onSubmit={submit}>
                ...
                <div className="mt-4 flex flex-col space-y-4 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
                    <div className="flex flex-col space-y-2 text-sm sm:flex-row sm:items-center sm:space-x-6 sm:space-y-0">
                        <Link
                            href={route('register')}
                            className="text-gray-600 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                        >
                            Need an account?
                        </Link>
                        {canResetPassword && (
